...
tmux new -d -s agent 'NODE_ENV=development AGENT_DEV_CREATE_DEVELOPMENT_PROJECTS=true yarn ts-node -r tsconfig-paths/register entrypoints/agent.ts || true && /bin/bash'
