 ...
 */
export declare function instanceOfMmdsConfig(value: object): boolean;
export declare function MmdsConfigFromJSON(json: any): MmdsConfig;
export declare function MmdsConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): MmdsConfig;
export declare function MmdsConfigToJSON(value?: MmdsConfig | null): any;
