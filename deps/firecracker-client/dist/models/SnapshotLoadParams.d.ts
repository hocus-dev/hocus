 ...
 */
export declare function instanceOfSnapshotLoadParams(value: object): boolean;
export declare function SnapshotLoadParamsFromJSON(json: any): SnapshotLoadParams;
export declare function SnapshotLoadParamsFromJSONTyped(json: any, ignoreDiscriminator: boolean): SnapshotLoadParams;
export declare function SnapshotLoadParamsToJSON(value?: SnapshotLoadParams | null): any;
